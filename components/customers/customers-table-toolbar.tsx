        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <input
              ...
              className="h-8 w-full rounded-lg border border-border/70 bg-card/70 pl-8 pr-8 text-xs text-foreground placeholder:text-muted-foreground focus-visible:border-primary/40 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/20 shadow-2xs transition-colors"
            />
            {searchValue && (
              <button
                type="button"
