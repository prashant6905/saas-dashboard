    ...
    <header className="sticky top-0 z-30 flex h-15 w-full items-center justify-between border-b border-border/70 bg-card/70 px-4 sm:px-6 backdrop-blur-xl transition-colors">
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="text-[#475569] dark:text-[#94A3B8] hover:text-[#111827] dark:hover:text-[#F8FAFC] transition-colors hidden sm:inline font-medium">UrbanNest D2C</span>
          <ChevronRight className="h-3.5 w-3.5 text-[#64748B] dark:text-[#94A3B8] shrink-0 hidden sm:inline" />
          <span className="text-[#111827] dark:text-[#F8FAFC] font-semibold tracking-tight truncate max-w-[180px] sm:max-w-none">{title}</span>
        </nav>
      </div>
      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          >
            <Search className="h-3.5 w-3.5 shrink-0 text-[#475569] dark:text-[#94A3B8] transition-colors group-hover:text-[#111827] dark:group-hover:text-[#F8FAFC]" />
            <span className="truncate text-[#64748B] dark:text-[#94A3B8] group-hover:text-[#111827] dark:group-hover:text-[#F8FAFC] font-medium">Search commands...</span>
            <kbd className="ml-auto pointer-events-none inline-flex h-4.5 select-none items-center gap-0.5 rounded-md border border-border/70 bg-neutral-100 dark:bg-slate-800/80 px-1.5 font-mono text-[9px] font-semibold text-[#475569] dark:text-[#94A3B8]">
